...
var Ft = Object.defineProperty,
  ...
  kt = (e, t, a) =>
    t in e
      ? Ft(e, t, { enumerable: !0, configurable: !0, writable: !0, value: a })
      : (e[t] = a),
  Me = (e, t) => {
    for (var a in t || (t = {})) qt.call(t, a) && kt(e, a, t[a]);
    if (Ct) for (var a of Ct(t)) Kt.call(t, a) && kt(e, a, t[a]);
    return e;
  };
function Yt() {
  var e;
  const t = (e = z.state.themeMode) != null ? e : "dark",
    a = {
      light: {
        foreground: {
          1: "rgb(20,20,20)",
...
function Qt() {
  const { themeVariables: e } = z.state;
  return {
...
const w = {
    ...
    setTheme() {
      const e = document.querySelector(":root"),
        { themeVariables: t } = z.state;
      if (e) {
        const a = Me(Me(Me(Me({}, Yt()), $t()), t), Qt());
        Object.entries(a).forEach(([o, r]) => e.style.setProperty(o, r));
      }
    },
  ...
  Xt = g`button{display:flex;border-radius:var(--w3m-button-hover-highlight-border-radius);flex-direction:column;justify-content:center;padding:5px;width:100px}button:active{background-color:var(--w3m-color-overlay)}button:disabled{opacity:.7}@media(hover:hover){button:hover{background-color:var(--w3m-color-overlay)}}button>div{display:flex;justify-content:center;align-items:center;width:32px;height:32px;box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);background-color:var(--w3m-accent-color);border-radius:var(--w3m-icon-button-border-radius);margin-bottom:4px}button path{fill:var(--w3m-accent-fill-color)}`;
var Jt = Object.defineProperty,
  er = Object.getOwnPropertyDescriptor,
  ve = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? er(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && Jt(t, a, r), r;
  };
let Y = class extends m {
  ...
  render() {
    return l`<button @click="${this.onClick}" .disabled="${!!this
      .loading}"><div>${
      this.loading
...
let G = class extends m {
  ...
  render() {
    ...
    return (
      ...
      l`<button class="${P(e)}" ?disabled="${this.disabled}" @click="${
        this.onClick
      }">${
        this.iconLeft
...
let be = class extends m {
  ...
  render() {
    ...
    return l`<button ?disabled="${this.disabled}" class="${P(
      e
    )}"><slot></slot></button>`;
  }
};
(be.styles = [w.globalCss, or]),
  Ke([c()], be.prototype, "disabled", 2),
  Ke([c()], be.prototype, "variant", 2),
  (be = Ke([h("w3m-button-big")], be));
const lr = g`:host{background-color:var(--w3m-color-bg-2);border-top:1px solid var(--w3m-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
var sr = Object.defineProperty,
  cr = Object.getOwnPropertyDescriptor,
  dr = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? cr(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && sr(t, a, r), r;
  };
...
(Ye.styles = [w.globalCss, lr]), (Ye = dr([h("w3m-info-footer")], Ye));
const p = {
...
let Le = class extends m {
  constructor() {
    super(),
      ...
      (this.unsubscribeRouter = x.subscribe((e) => {
  ...
  logoTemplate() {
    var e;
    const t =
      (e = z.state.themeVariables) == null ? void 0 : e["--w3m-logo-image-url"];
    return t ? l`<img src="${t}">` : p.WALLET_CONNECT_LOGO;
  }
  render() {
    ...
    return l`<div class="w3m-toolbar-placeholder"></div><div class="w3m-toolbar">${this.logoTemplate()}<div class="${P(
      ...
      p.HELP_ICON
    }</button> <button @click="${R.close}">${
      p.CROSS_ICON
    }</button></div></div>`;
  }
};
(Le.styles = [w.globalCss, mr]),
  Ot([f()], Le.prototype, "isHelp", 2),
  (Le = Ot([h("w3m-modal-backcard")], Le));
const wr = g`main{padding:20px;padding-top:0;width:100%}`;
var gr = Object.defineProperty,
  ur = Object.getOwnPropertyDescriptor,
  vr = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? ur(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && gr(t, a, r), r;
  };
...
(Qe.styles = [w.globalCss, wr]), (Qe = vr([h("w3m-modal-content")], Qe));
const br = g`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--w3m-color-bg-2)}`;
var fr = Object.defineProperty,
  xr = Object.getOwnPropertyDescriptor,
  yr = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? xr(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && fr(t, a, r), r;
  };
...
(Xe.styles = [w.globalCss, br]), (Xe = yr([h("w3m-modal-footer")], Xe));
...
var kr = Object.defineProperty,
  ...
  fe = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? $r(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && kr(t, a, r), r;
  };
let Q = class extends m {
  ...
  backBtnTemplate() {
    return l`<button class="w3m-back-btn" @click="${x.goBack}">${p.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
  ...
  render() {
    const e = { "w3m-border": this.border },
      t = x.state.history.length > 1,
      a = this.title
        ? l`<w3m-text variant="big-bold">${this.title}</w3m-text>`
        : l`<slot></slot>`;
    return l`<header class="${P(e)}">${
      t ? this.backBtnTemplate() : null
    } ${a} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
  }
};
(Q.styles = [w.globalCss, Cr]),
  fe([c()], Q.prototype, "title", 2),
  fe([c()], Q.prototype, "onAction", 2),
  fe([c()], Q.prototype, "actionIcon", 2),
  fe([c()], Q.prototype, "border", 2),
  (Q = fe([h("w3m-modal-header")], Q));
const Or = {
  ...
  N = {
    externalWallets() {
      let e = W.client().getConnectors();
      return (e = e.filter((t) => t.id !== "injected")), e;
    },
    manualWallets() {
      var e, t;
      const { mobileWallets: a, desktopWallets: o } = L.state,
        r = (e = N.recentWallet()) == null ? void 0 : e.id,
        i = u.isMobile() ? a : o,
        n = i == null ? void 0 : i.filter((d) => r !== d.id);
      return (t = u.isMobile()
        ? n == null
          ? void 0
    ...
    installedInjectedWallets() {
      ...
      const { namespace: e } = W.client(),
        { injectedWallets: t } = I.state;
      let a = t.filter(
        ({ injected: o }) =>
          !!o.some(
            (r) =>
              W.client().safeCheckInjectedProvider(r.injected_id) &&
              r.namespace === e
          )
      );
      return (
    ...
    injectedWallets() {
      const { explorerExcludedWalletIds: e, explorerRecommendedWalletIds: t } =
          L.state,
        a = u.isMobile();
      if (e === "ALL" || a) return [];
      const { namespace: o } = W.client(),
        { injectedWallets: r } = I.state;
      return r.filter(({ id: i, injected: n }) => {
        const d = u.isArray(e) ? e : [],
          v = u.isArray(t) ? t : [];
        return !!n.some(
          (y) => y.namespace === o && !d.includes(i) && !v.includes(i)
        );
      });
    },
    recentWallet() {
    ...
    recomendedWallets(e = !1) {
      var t;
      const a = N.installedInjectedWallets().map(({ id: n }) => n),
        o = e || (t = N.recentWallet()) == null ? void 0 : t.id,
        r = [...a, o],
        { recomendedWallets: i } = I.state;
      return i.filter((n) => !r.includes(n.id));
    },
  },
  s = {
    ...
    getWalletIcon({ id: e, image_id: t }) {
      ...
      return a != null && a[e] ? a[e] : t ? I.getWalletImageUrl(t) : "";
    },
    getWalletName(e, t = !1) {
    ...
    getChainIcon(e) {
      var t;
      const a = Or[e],
        { projectId: o, chainImages: r } = L.state;
    ...
    getTokenIcon(e) {
      var t, a;
      const o = (t = Ir[e]) == null ? void 0 : t.icon,
        { projectId: r, tokenImages: i } = L.state;
      return (a = i == null ? void 0 : i[e]) != null
        ? a
        : r && o
        ? I.getAssetImageUrl(o)
        : "";
    },
    isMobileAnimation() {
    ...
    async preloadImage(e) {
      const t = new Promise((a, o) => {
        const r = new Image();
        (r.onload = a), (r.onerror = o), (r.src = e);
      });
      return Promise.race([t, u.wait(3e3)]);
    },
    getErrorMessage(e) {
    ...
    debounce(e, t = 500) {
      ...
      return (...o) => {
        ...
        a && clearTimeout(a), (a = setTimeout(r, t));
      };
    },
    handleMobileLinking(e) {
      const { pairingUri: t } = A.state,
        { mobile: a, name: o } = e,
        r = a == null ? void 0 : a.native,
        i = a == null ? void 0 : a.universal;
      s.setRecentWallet(e);
      function n(d) {
        let v = "";
        r
          ? (v = u.formatUniversalUrl(r, d, o))
          : i && (v = u.formatNativeUrl(i, d, o)),
          u.openHref(v, "_self");
      }
      n(t);
    },
    handleAndroidLinking() {
      ...
      u.setWalletConnectAndroidDeepLink(e), u.openHref(e, "_self");
    },
    async handleUriCopy() {
      try {
        const { pairingUri: e } = A.state;
    ...
    async handleConnectorConnection(e, t) {
      try {
        ...
        await W.client().connectConnector(e, a == null ? void 0 : a.id),
          R.close();
      } catch (a) {
        console.error(a), t ? t() : j.openToast(s.getErrorMessage(a), "error");
      }
    },
    getCustomImageUrls() {
      const { chainImages: e, walletImages: t } = L.state,
        a = Object.values(e ?? {}),
        o = Object.values(t ?? {});
      return Object.values([...a, ...o]);
    },
    truncate(e, t = 8) {
      return e.length <= t
        ? e
    ...
    generateAvatarColors(e) {
      var t;
      const a = (t = e.match(/.{1,7}/g)) == null ? void 0 : t.splice(0, 5),
        o = [];
      a == null ||
        a.forEach((i) => {
          let n = 0;
      ...
      if (r) {
        ...
        Object.entries(i).forEach(([n, d]) => r.style.setProperty(n, d));
      }
    },
    setRecentWallet(e) {
      try {
    ...
    getCachedRouterWalletPlatforms() {
      const {
        ...
        r = N.installedInjectedWallets(),
        i = !!(o != null && o.length),
        n = r.some((H) => H.id === e),
        d = !!(t != null && t.native),
        v = !!(t != null && t.universal),
  ...
  Er = g`.w3m-router{overflow:hidden;will-change:transform}.w3m-content{display:flex;flex-direction:column}`;
var Ar = Object.defineProperty,
  jr = Object.getOwnPropertyDescriptor,
  Je = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? jr(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && Ar(t, a, r), r;
  };
let xe = class extends m {
  constructor() {
    super(),
  ...
  firstUpdated() {
    (this.resizeObserver = new ResizeObserver(([e]) => {
      ...
      this.oldHeight !== "0px" &&
        oe(this.routerEl, { height: [this.oldHeight, t] }, { duration: 0.2 }),
        (this.oldHeight = t);
    })),
...
(xe.styles = [w.globalCss, Er]),
  Je([f()], xe.prototype, "view", 2),
  Je([f()], xe.prototype, "prevView", 2),
  (xe = Je([h("w3m-modal-router")], xe));
const Pr = g`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--w3m-notification-border-radius);border:1px solid var(--w3m-color-overlay);background-color:var(--w3m-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--w3m-color-bg-3)}}.w3m-success path{fill:var(--w3m-accent-color)}.w3m-error path{fill:var(--w3m-error-color)}`;
var Wr = Object.defineProperty,
  Mr = Object.getOwnPropertyDescriptor,
  It = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? Mr(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && Wr(t, a, r), r;
  };
let Te = class extends m {
  constructor() {
    super(),
      ...
      (this.unsubscribe = void 0),
      (this.timeout = void 0),
      (this.unsubscribe = j.subscribe((e) => {
        e.open
          ? ((this.open = !0),
...
let X = class extends m {
  ...
  render() {
    ...
    return l`<button @click="${this.onClick}" class="${P(
      e
...
let _e = class extends m {
  ...
  render() {
    ...
    return e
      ...
      : l`${p.NETWORK_PLACEHOLDER}`;
  }
};
(_e.styles = [w.globalCss, Nr]),
  Et([c()], _e.prototype, "chainId", 2),
  (_e = Et([h("w3m-network-image")], _e));
const Zr = 0.1,
  At = 2.5,
  U = 7;
function et(e, t, a) {
  return e === t ? !1 : (e - t < 0 ? t - e : e - t) <= a + Zr;
}
function Hr(e, t) {
  ...
  return a.reduce(
    (r, i, n) => (n % o === 0 ? r.push([i]) : r[r.length - 1].push(i)) && r,
    []
  );
}
const Br = {
    generate(e, t, a) {
      ...
      v.forEach(({ x: E, y: C }) => {
        ...
        for (let B = 0; B < v.length; B += 1) {
          const ne = d * (U - B * 2);
          i.push(
            b`<rect fill="${B % 2 === 0 ? o : r}" height="${ne}" rx="${
              ne * _
            }" ry="${ne * _}" width="${ne}" x="${T + d * B}" y="${$ + d * B}">`
          );
        }
      });
      ...
      return (
        ...
        Object.entries(ue)
          .map(([E, C]) => {
            const T = C.filter(($) => C.every((_) => !et($, _, d)));
            return [Number(E), T];
          })
          .forEach(([E, C]) => {
            C.forEach((T) => {
              i.push(b`<circle cx="${E}" cy="${T}" fill="${o}" r="${d / At}">`);
            });
          }),
        Object.entries(ue)
          .filter(([E, C]) => C.length > 1)
          .map(([E, C]) => {
            const T = C.filter(($) => C.some((_) => et($, _, d)));
            return [Number(E), T];
          })
          .map(([E, C]) => {
            C.sort(($, _) => ($ < _ ? -1 : 1));
            const T = [];
            for (const $ of C) {
              const _ = T.find((B) => B.some((ne) => et($, ne, d)));
              _ ? _.push($) : T.push([$]);
            }
          ...
          .forEach(([E, C]) => {
            C.forEach(([T, $]) => {
              i.push(
                b`<line x1="${E}" x2="${E}" y1="${T}" y2="${$}" stroke="${o}" stroke-width="${
                  d / (At / 2)
...
let F = class extends m {
  ...
  svgTemplate() {
    const e = z.state.themeMode === "light" ? this.size : this.size - 36;
    return b`<svg height="${e}" width="${e}">${Br.generate(
      this.uri,
      e,
      e / 4
    )}</svg>`;
  ...
  render() {
    const e = { "w3m-dark": z.state.themeMode === "dark" };
    return l`<div style="${`width: ${this.size}px`}" class="${P(e)}">${
...
let S = class extends m {
  ...
  handleClick() {
    ie.click({ name: "WALLET_BUTTON", walletId: this.walletId }),
      this.onClick();
  }
  render() {
    var e;
    return l`<button @click="${this.handleClick.bind(
      ...
      (e = this.label) != null ? e : s.getWalletName(this.name, !0)
    }</w3m-text>${this.sublabelTemplate()}</div></button>`;
  }
};
(S.styles = [w.globalCss, aa]),
...
let ce = class extends m {
  ...
  render() {
    ...
    return l`${
      t.length
        ? l`<div><img src="${t}" alt="${this.id}"></div>`
        : p.WALLET_PLACEHOLDER
    }`;
  }
};
(ce.styles = [w.globalCss, na]),
  Re([c()], ce.prototype, "walletId", 2),
  Re([c()], ce.prototype, "imageId", 2),
  Re([c()], ce.prototype, "imageUrl", 2),
  (ce = Re([h("w3m-wallet-image")], ce));
var ca = Object.defineProperty,
  da = Object.getOwnPropertyDescriptor,
  ma = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? da(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && ca(t, a, r), r;
  };
let Wt = class extends m {
  constructor() {
    super(),
      ...
      this.fetchProfile(),
      this.fetchBalance(),
      (this.unwatchAccount = W.client().watchAccount((e) => {
        const { address: t, isConnected: a } = k.state;
        e.isConnected &&
          e.address !== t &&
          (this.fetchProfile(e.address),
          this.fetchBalance(e.address),
          k.setAddress(e.address)),
          e.isConnected || k.resetAccount(),
          a !== e.isConnected && R.close(),
          !a && e.isConnected
            ? ie.track({ name: "ACCOUNT_CONNECTED" })
            : a && !e.isConnected && ie.track({ name: "ACCOUNT_DISCONNECTED" }),
          k.setIsConnected(e.isConnected);
      }));
  }
  disconnectedCallback() {
    var e;
  ...
  async fetchProfile(e) {
    var t;
    const a = (t = O.state.chains) == null ? void 0 : t.find((o) => o.id === 1);
    if (L.state.enableAccountView && a)
      try {
        await k.fetchProfile(s.preloadImage, e);
      } catch (o) {
        console.error(o), j.openToast(s.getErrorMessage(o), "error");
      }
  }
  async fetchBalance(e) {
    if (L.state.enableAccountView)
      try {
        await k.fetchBalance(e);
      } catch (t) {
        console.error(t), j.openToast(s.getErrorMessage(t), "error");
      }
  }
};
Wt = ma([h("w3m-account-context")], Wt);
var ha = Object.defineProperty,
  pa = Object.getOwnPropertyDescriptor,
  Mt = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? pa(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && ha(t, a, r), r;
  };
let at = class extends m {
  ...
  async loadImages(e) {
    try {
      e != null &&
        e.length &&
        (await Promise.all(e.map(async (t) => s.preloadImage(t))));
    } catch {
  ...
  async preloadListings() {
    ...
    if (L.state.enableExplorer) {
      ...
      const { recomendedWallets: a } = I.state,
        o = N.installedInjectedWallets(),
        r =
          (e = t == null ? void 0 : t.map((d) => s.getChainIcon(d.id))) != null
            ? e
            : [],
        i = a.map((d) => s.getWalletIcon(d)),
        n = o.map((d) => s.getWalletIcon(d));
      await this.loadImages([...r, ...i, ...n]);
  ...
  async preloadData() {
    try {
      ...
      console.error(e), j.openToast("Failed preloading", "error");
    }
  }
};
Mt([f()], at.prototype, "preload", 2),
  (at = Mt([h("w3m-explorer-context")], at));
var wa = Object.defineProperty,
  ga = Object.getOwnPropertyDescriptor,
  Lt = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? ga(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && wa(t, a, r), r;
  };
let ot = class extends m {
  constructor() {
    super(), (this.activeChainId = void 0), (this.unwatchNetwork = void 0);
    const e = O.getSelectedChain();
    (this.activeChainId = e == null ? void 0 : e.id),
      (this.unwatchNetwork = W.client().watchNetwork((t) => {
        const a = t.chain;
        a &&
...
Lt([f()], ot.prototype, "activeChainId", 2),
  (ot = Lt([h("w3m-network-context")], ot));
var ua = Object.defineProperty,
  va = Object.getOwnPropertyDescriptor,
  ba = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? va(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && ua(t, a, r), r;
  };
let Tt = class extends m {
  constructor() {
    super(),
      ...
      w.setTheme(),
      (this.unsubscribeTheme = z.subscribe(w.setTheme)),
  ...
  async preloadThemeImages() {
    try {
      ...
      t.length && (await Promise.all(t.map(async (a) => s.preloadImage(a))));
    } catch {
      console.info("Unsuccessful attempt at preloading some images");
    }
  }
};
Tt = ba([h("w3m-theme-context")], Tt);
var fa = Object.defineProperty,
  xa = Object.getOwnPropertyDescriptor,
  ya = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? xa(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && fa(t, a, r), r;
  };
const Ca = 24e4,
  ka = 1e3;
var _t;
let Nt = class extends m {
  constructor() {
    super(),
      ...
      (this.selectedChainId =
        (_t = O.state.selectedChain) == null ? void 0 : _t.id),
      (this.isAccountConnected = k.state.isConnected),
      (this.lastRetry = Date.now()),
      (this.unwatchOptions = O.subscribe((e) => {
        var t, a;
        ((t = e.selectedChain) == null ? void 0 : t.id) !==
          this.selectedChainId &&
          ((this.selectedChainId =
            (a = e.selectedChain) == null ? void 0 : a.id),
          this.connectAndWait());
      })),
      (this.unwatchAccount = k.subscribe((e) => {
        (this.isAccountConnected !== e.isConnected || !this.isGenerated) &&
          ((this.isAccountConnected = e.isConnected), this.connectAndWait());
      })),
      (this.unwatchWcConnection = A.subscribe((e) => {
  ...
  async connectAndWait() {
    const { pairingEnabled: e } = A.state;
    if ((clearTimeout(this.timeout), !this.isAccountConnected && e)) {
      (this.isGenerated = !0),
        (this.timeout = setTimeout(this.connectAndWait.bind(this), Ca));
      try {
        ...
        console.error(t),
          ...
          Date.now() - this.lastRetry >= ka &&
            ((this.lastRetry = Date.now()), this.connectAndWait());
      }
    }
  }
};
Nt = ya([h("w3m-wc-connection-context")], Nt);
const $a = g`:host{all:initial}div{display:flex;align-items:center;background-color:var(--w3m-color-overlay);box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);border-radius:var(--w3m-button-border-radius);padding:4px 4px 4px 8px}div button{border-radius:var(--w3m-secondary-button-border-radius);padding:4px 8px;padding-left:4px;height:auto;margin-left:10px;color:var(--w3m-accent-fill-color);background-color:var(--w3m-accent-color)}.w3m-no-avatar{padding-left:8px}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--w3m-color-overlay)}button:hover::after{background-color:var(--w3m-color-overlay)}w3m-avatar{margin-right:6px}w3m-button-big w3m-avatar{margin-left:-5px}`;
var Oa = Object.defineProperty,
  Ia = Object.getOwnPropertyDescriptor,
  it = (e, t, a, o) => {
    for (
...
let $e = class extends m {
  ...
  onOpen() {
    ie.click({ name: "ACCOUNT_BUTTON" }), R.open({ route: "Account" });
  }
  accountTemplate() {
    const e = this.avatar === "show";
    return l`${
      e ? l`<w3m-avatar></w3m-avatar>` : null
  ...
  render() {
    ...
    return e
      ? l`<div><w3m-balance></w3m-balance><button @click="${
          this.onOpen
        }" class="${P(t)}">${this.accountTemplate()}</button></div>`
      : l`<w3m-button-big @click="${
          this.onOpen
        }">${this.accountTemplate()}</w3m-button-big>`;
  }
};
($e.styles = [w.globalCss, $a]),
  it([c()], $e.prototype, "balance", 2),
  it([c()], $e.prototype, "avatar", 2),
  ($e = it([h("w3m-account-button")], $e));
const Ea = g`button{display:flex;border-radius:var(--w3m-button-hover-highlight-border-radius);flex-direction:column;justify-content:center;padding:5px;width:100px}button:active{background-color:var(--w3m-color-overlay)}@media(hover:hover){button:hover{background-color:var(--w3m-color-overlay)}}button:disabled{pointer-events:none}w3m-network-image{width:32px;height:32px}w3m-text{margin-top:4px}`;
var Aa = Object.defineProperty,
  ja = Object.getOwnPropertyDescriptor,
  nt = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? ja(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && Aa(t, a, r), r;
  };
let Oe = class extends m {
  constructor() {
    ...
    (this.chainId = e == null ? void 0 : e.id),
      ...
      (this.unsubscribeNetwork = O.subscribe(({ selectedChain: t }) => {
  ...
  render() {
    const { chains: e, selectedChain: t } = O.state,
      a = e == null ? void 0 : e.map((i) => i.id),
      o = t && (a == null ? void 0 : a.includes(t.id)),
      r = e && e.length <= 1 && o;
    return l`<button @click="${this.onClick}" ?disabled="${r}"><w3m-network-image chainId="${this.chainId}"></w3m-network-image><w3m-text variant="xsmall-regular" color="accent">${this.label}</w3m-text></button>`;
  }
};
(Oe.styles = [w.globalCss, Ea]),
  nt([f()], Oe.prototype, "chainId", 2),
  nt([f()], Oe.prototype, "label", 2),
  (Oe = nt([h("w3m-account-network-button")], Oe));
const Pa = g`@keyframes slide{0%{background-position:0 0}100%{background-position:200px 0}}w3m-text{padding:1px 0}.w3m-loading{background:linear-gradient(270deg,var(--w3m-color-fg-1) 36.33%,var(--w3m-color-fg-3) 42.07%,var(--w3m-color-fg-1) 83.3%);background-size:200px 100%;background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation-name:slide;animation-duration:1.5s;animation-iteration-count:infinite;animation-timing-function:linear}`;
var Wa = Object.defineProperty,
  Ma = Object.getOwnPropertyDescriptor,
  Ie = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? Ma(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
...
let J = class extends m {
  constructor() {
    super(),
      ...
      (this.unsubscribeAccount = k.subscribe(
        ({ address: e, profileName: t, profileLoading: a }) => {
  ...
  render() {
    ...
    return l`<w3m-text class="${P(a)}" variant="${
      t ? "medium-regular" : "big-bold"
    }" color="${t ? "inverse" : "primary"}">${
      this.name ? this.name : s.truncate((e = this.address) != null ? e : "")
    }</w3m-text>`;
  }
};
(J.styles = [w.globalCss, Pa]),
  Ie([f()], J.prototype, "address", 2),
  Ie([f()], J.prototype, "name", 2),
  Ie([f()], J.prototype, "loading", 2),
  Ie([c()], J.prototype, "variant", 2),
  (J = Ie([h("w3m-address-text")], J));
const M = {
    onConnecting(e) {
    ...
    manualWalletsTemplate() {
      return N.manualWallets().map(
        (e) =>
          l`<w3m-wallet-button walletId="${e.id}" name="${
            e.name
          }" .onClick="${() => this.onConnecting(e)}"></w3m-wallet-button>`
      );
    },
    recomendedWalletsTemplate(e = !1) {
      return N.recomendedWallets(e).map(
        (t) =>
    ...
    externalWalletsTemplate() {
      return N.externalWallets().map(
        (e) =>
          l`<w3m-wallet-button name="${e.name}" walletId="${
            e.id
    ...
    recentWalletTemplate() {
      ...
      if (e)
        return l`<w3m-wallet-button name="${e.name}" walletId="${
          e.id
        }" imageId="${e.image_id}" .recent="${!0}" .onClick="${() =>
          this.onConnecting(e)}"></w3m-wallet-button>`;
    },
    installedInjectedWalletsTemplate() {
      return N.installedInjectedWallets().map(
        (e) =>
          l`<w3m-wallet-button .installed="${!0}" name="${e.name}" walletId="${
            e.id
...
let lt = class extends m {
  ...
  render() {
    const { recomendedWallets: e } = I.state,
      t = [...e, ...e],
      a = M.externalWalletsTemplate(),
      o = M.installedInjectedWalletsTemplate(),
      r = [...o, ...a].length > 0,
    ...
    return l`<w3m-modal-header title="Connect your wallet" .onAction="${
      ...
      r
        ? l`<w3m-modal-footer><div class="w3m-title">${p.WALLET_ICON}<w3m-text variant="small-regular" color="accent">Other</w3m-text></div><div class="w3m-grid">${o} ${a}</div></w3m-modal-footer>`
        : null
      ...
      p.ARROW_UP_RIGHT_ICON
    }" .onClick="${() =>
      this.onGetWallet()}">I don't have a wallet</w3m-button></w3m-info-footer>`;
  }
};
(lt.styles = [w.globalCss, La]),
  (lt = Na([h("w3m-android-wallet-selection")], lt));
const Da = g`@keyframes slide{0%{transform:translateX(-50px)}100%{transform:translateX(200px)}}.w3m-placeholder,img{border-radius:50%;box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);display:block;position:relative;overflow:hidden!important;background-color:var(--w3m-color-av-1);background-image:radial-gradient(at 66% 77%,var(--w3m-color-av-2) 0,transparent 50%),radial-gradient(at 29% 97%,var(--w3m-color-av-3) 0,transparent 50%),radial-gradient(at 99% 86%,var(--w3m-color-av-4) 0,transparent 50%),radial-gradient(at 29% 88%,var(--w3m-color-av-5) 0,transparent 50%);transform:translateZ(0)}.w3m-loader{width:50px;height:100%;background:linear-gradient(270deg,transparent 0,rgba(255,255,255,.4) 30%,transparent 100%);animation-name:slide;animation-duration:1.5s;transform:translateX(-50px);animation-iteration-count:infinite;animation-timing-function:linear;animation-delay:.55s}.w3m-small{width:24px;height:24px}.w3m-medium{width:60px;height:60px}`;
var Ra = Object.defineProperty,
  Za = Object.getOwnPropertyDescriptor,
  Ee = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? Za(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && Ra(t, a, r), r;
  };
let ee = class extends m {
  constructor() {
    super(),
      ...
      (this.loading = !!k.state.profileLoading),
      (this.unsubscribeAccount = k.subscribe(
        ({ address: e, profileAvatar: t, profileLoading: a }) => {
  ...
  render() {
    ...
    return this.avatar
      ? l`<img class="${P(e)}" src="${this.avatar}">`
      : this.address
...
(ee.styles = [w.globalCss, Da]),
  Ee([f()], ee.prototype, "address", 2),
  Ee([f()], ee.prototype, "avatar", 2),
  Ee([f()], ee.prototype, "loading", 2),
  Ee([c()], ee.prototype, "size", 2),
  (ee = Ee([h("w3m-avatar")], ee));
const Ha = g`div{display:flex;align-items:center}w3m-token-image{width:28px;height:28px;margin-right:6px}`;
...
let Ae = class extends m {
  constructor() {
    ...
    super(),
      ...
      (this.amount = void 0),
      (this.unsubscribeAccount = void 0),
      (this.symbol = (e = k.state.balance) == null ? void 0 : e.symbol),
      (this.amount = (t = k.state.balance) == null ? void 0 : t.amount),
  ...
  render() {
    ...
    return (
      this.amount === "0.0"
        ...
        : typeof this.amount == "string" && (e = this.amount),
      l`<div><w3m-token-image symbol="${this.symbol}"></w3m-token-image><w3m-text variant="medium-regular" color="primary">${e} ${this.symbol}</w3m-text></div>`
    );
  }
};
(Ae.styles = [w.globalCss, Ha]),
  st([f()], Ae.prototype, "symbol", 2),
  st([f()], Ae.prototype, "amount", 2),
  (Ae = st([h("w3m-balance")], Ae));
const Ua = g`:host{all:initial}svg{width:28px;height:20px;margin:-1px 3px 0 -5px}svg path{fill:var(--w3m-accent-fill-color)}button:disabled svg path{fill:var(--w3m-color-fg-3)}w3m-spinner{margin:0 10px 0 0}`;
...
let de = class extends m {
  ...
  async onConnect() {
    (this.loading = !0),
      ie.click({ name: "CONNECT_BUTTON" }),
      await R.open(),
      R.state.open || (this.loading = !1);
  }
  async onDisconnect() {
    ie.click({ name: "DISCONNECT_BUTTON" }), await W.client().disconnect();
  }
  render() {
...
let K = class extends m {
  ...
  svgLoaderTemplate() {
    ...
    const a =
      (t =
        (e = z.state.themeVariables) == null
          ? void 0
          : e["--w3m-wallet-icon-large-border-radius"]) != null
        ? t
        : w.getPreset("--w3m-wallet-icon-large-border-radius");
    let o = 0;
    a.includes("%")
      ? (o = (88 / 100) * parseInt(a, 10))
      : (o = parseInt(a, 10)),
      (o *= 1.17);
    const r = 317 - o * 1.57,
      i = 425 - o * 1.8;
    return l`<svg viewBox="0 0 110 110" width="110" height="110"><rect id="w3m-loader" x="2" y="2" width="106" height="106" rx="${o}"/><use xlink:href="#w3m-loader" stroke-dasharray="106 ${r}" stroke-dashoffset="${i}"></use></svg>`;
  }
  render() {
...
(K.styles = [w.globalCss, Ga]),
  me([c()], K.prototype, "walletId", 2),
  me([c()], K.prototype, "imageId", 2),
  me([c()], K.prototype, "isError", 2),
  me([c()], K.prototype, "isStale", 2),
  me([c()], K.prototype, "label", 2),
  (K = me([h("w3m-connector-waiting")], K));
var Ka = Object.defineProperty,
  Ya = Object.getOwnPropertyDescriptor,
  he = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? Ya(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && Ka(t, a, r), r;
  };
let te = class extends m {
  constructor() {
    super(),
      ...
      (this.unsubscribeAccount = k.subscribe(({ isConnected: e }) => {
        this.isConnected = e;
      }));
  }
  disconnectedCallback() {
  ...
  render() {
    const { enableAccountView: e } = L.state,
      t = this.balance,
      a = this.label,
      o = this.icon,
      r = this.avatar;
    return this.isConnected && e
      ? l`<w3m-account-button balance="${t}" avatar="${r}"></w3m-account-button>`
      : l`<w3m-connect-button label="${
          this.isConnected ? "Disconnect" : a
        }" icon="${o}"></w3m-connect-button>`;
  }
};
he([f()], te.prototype, "isConnected", 2),
  he([c()], te.prototype, "label", 2),
  he([c()], te.prototype, "icon", 2),
  he([c()], te.prototype, "avatar", 2),
  he([c()], te.prototype, "balance", 2),
  (te = he([h("w3m-core-button")], te));
const Qa = g`.w3m-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between}.w3m-desktop-title,.w3m-mobile-title{display:flex;align-items:center}.w3m-mobile-title{justify-content:space-between;margin-bottom:20px;margin-top:-10px}.w3m-desktop-title{margin-bottom:10px;padding:0 10px}.w3m-subtitle{display:flex;align-items:center}.w3m-subtitle:last-child path{fill:var(--w3m-color-fg-3)}.w3m-desktop-title svg,.w3m-mobile-title svg{margin-right:6px}.w3m-desktop-title path,.w3m-mobile-title path{fill:var(--w3m-accent-color)}`;
var Xa = Object.defineProperty,
  ...
  eo = (e, t, a, o) => {
    for (
      ...
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && Xa(t, a, r), r;
  };
let ct = class extends m {
  render() {
    const { explorerExcludedWalletIds: e, enableExplorer: t } = L.state,
      a = e !== "ALL" && t,
      o = M.manualWalletsTemplate(),
      r = M.recomendedWalletsTemplate(),
      i = M.externalWalletsTemplate(),
      n = M.recentWalletTemplate();
    let d = [...M.installedInjectedWalletsTemplate(), n, ...i, ...o, ...r];
    d = d.filter(Boolean);
    ...
    return l`<w3m-modal-header .border="${!0}" title="Connect your wallet" .onAction="${
      ...
      H
        ? l`<w3m-modal-footer><div class="w3m-desktop-title">${
            p.DESKTOP_ICON
...
(ct.styles = [w.globalCss, Qa]),
  (ct = eo([h("w3m-desktop-wallet-selection")], ct));
const to = g`div{background-color:var(--w3m-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--w3m-color-bg-3);text-align:center}a{color:var(--w3m-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
var ro = Object.defineProperty,
  ao = Object.getOwnPropertyDescriptor,
  oo = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? ao(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && ro(t, a, r), r;
  };
let dt = class extends m {
  render() {
    const { termsOfServiceUrl: e, privacyPolicyUrl: t } = L.state;
    return e ?? t
      ? l`<div><w3m-text variant="small-regular" color="secondary">By connecting your wallet to this app, you agree to the app's ${
          e
            ? l`<a href="${e}" target="_blank" rel="noopener noreferrer">Terms of Service</a>`
            : null
        } ${e && t ? "and" : null} ${
          t
            ? l`<a href="${t}" target="_blank" rel="noopener noreferrer">Privacy Policy</a>`
            : null
        }</w3m-text></div>`
      : null;
  }
};
(dt.styles = [w.globalCss, to]), (dt = oo([h("w3m-legal-notice")], dt));
const io = g`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
var no = Object.defineProperty,
  lo = Object.getOwnPropertyDescriptor,
  so = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? lo(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && no(t, a, r), r;
  };
let mt = class extends m {
  ...
  render() {
    ...
    return l`<w3m-modal-header title="Connect your wallet" .onAction="${
      this.onQrcode
    }" .actionIcon="${p.QRCODE_ICON}"></w3m-modal-header>${
      H
        ? l`<w3m-modal-content><div>${y} ${
            v
              ? l`<w3m-view-all-wallets-button></w3m-view-all-wallets-button>`
              : null
...
let je = class extends m {
  constructor() {
    super(),
      ...
      (this.unsubscribeModal = R.subscribe((e) => {
  ...
  onCloseModal(e) {
    e.target === e.currentTarget && R.close();
  }
  onOpenModalEvent() {
    this.toggleBodyScroll(!1),
      ...
      setTimeout(async () => {
        const e = s.isMobileAnimation()
          ...
          a = 0.2;
        await Promise.all([
          oe(this.overlayEl, { opacity: [0, 1] }, { delay: t, duration: a })
            .finished,
          oe(this.containerEl, e, { delay: t, duration: a }).finished,
        ]),
          (this.active = !0);
      }, 0);
  }
  async onCloseModalEvent() {
    ...
    const e = s.isMobileAnimation()
      ...
      t = 0.2;
    await Promise.all([
      oe(this.overlayEl, { opacity: [1, 0] }, { duration: t }).finished,
      oe(this.containerEl, e, { duration: t }).finished,
    ]),
  ...
  render() {
    ...
    return l`<w3m-explorer-context></w3m-explorer-context><w3m-theme-context></w3m-theme-context><w3m-wc-connection-context></w3m-wc-connection-context><w3m-account-context></w3m-account-context><w3m-network-context></w3m-network-context><div id="w3m-modal" class="${P(
      e
    )}" @click="${
      this.onCloseModal
...
(je.styles = [w.globalCss, co]),
  ht([f()], je.prototype, "open", 2),
  ht([f()], je.prototype, "active", 2),
  (je = ht([h("w3m-modal")], je));
const po = g`:host{all:initial}w3m-network-image{margin-left:-6px;margin-right:6px;width:28px;height:28px}`;
var wo = Object.defineProperty,
  go = Object.getOwnPropertyDescriptor,
  He = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? go(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && wo(t, a, r), r;
  };
let pe = class extends m {
  ...
  onSetChainData(e) {
    if (e) {
      const { chains: t } = O.state,
        a = t == null ? void 0 : t.map((o) => o.id);
      (this.chainId = e.id.toString()),
        (this.wrongNetwork = !(a != null && a.includes(e.id))),
        (this.label = this.wrongNetwork ? "Wrong Network" : e.name);
    }
  }
  onClick() {
    ie.click({ name: "NETWORK_BUTTON" }), R.open({ route: "SelectNetwork" });
  }
  render() {
    var e;
    const { chains: t } = O.state,
    ...
    return l`<w3m-button-big @click="${
      this.onClick
    }" ?disabled="${!a}"><w3m-network-image chainId="${
      this.chainId
...
(we.styles = [w.globalCss, uo]),
  Be([c()], we.prototype, "chainId", 2),
  Be([c()], we.prototype, "isError", 2),
  Be([c()], we.prototype, "label", 2),
  (we = Be([h("w3m-network-waiting")], we));
const fo = g`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}w3m-button{margin:0 5px}`;
var xo = Object.defineProperty,
  yo = Object.getOwnPropertyDescriptor,
  re = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? yo(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && xo(t, a, r), r;
  };
let V = class extends m {
  ...
  render() {
    return l`<div>${this.isRetry ? l`<slot></slot>` : null} ${
      this.isMobile
        ? l`<w3m-button .onClick="${this.onMobile}" .iconLeft="${p.MOBILE_ICON}" variant="outline">Mobile</w3m-button>`
        : null
    } ${
      this.isInjected
        ? l`<w3m-button .onClick="${this.onInjected}" .iconLeft="${p.WALLET_ICON}" variant="outline">Browser</w3m-button>`
        : null
    } ${
      this.isDesktop
        ? l`<w3m-button .onClick="${this.onDesktop}" .iconLeft="${p.DESKTOP_ICON}" variant="outline">Desktop</w3m-button>`
        : null
    } ${
      this.isWeb
        ? l`<w3m-button .onClick="${this.onWeb}" .iconLeft="${p.GLOBE_ICON}" variant="outline">Web</w3m-button>`
        : null
    }</div>`;
  }
};
(V.styles = [w.globalCss, fo]),
  re([c()], V.prototype, "isMobile", 2),
  re([c()], V.prototype, "isInjected", 2),
  re([c()], V.prototype, "isInjectedInstalled", 2),
  re([c()], V.prototype, "isDesktop", 2),
  re([c()], V.prototype, "isWeb", 2),
  re([c()], V.prototype, "isRetry", 2),
  (V = re([h("w3m-platform-selection")], V));
const Co = g`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--w3m-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.w3m-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--w3m-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--w3m-color-bg-2);box-shadow:inset 0 0 0 1px var(--w3m-color-overlay)}button:active{background-color:var(--w3m-color-overlay)}@media(hover:hover){button:hover{background-color:var(--w3m-color-overlay)}}.w3m-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--w3m-wallet-icon-border-radius)/ 2);border:1px solid var(--w3m-color-overlay)}.w3m-icons svg{width:21px;height:21px}.w3m-icons img:nth-child(1),.w3m-icons img:nth-child(2),.w3m-icons svg:nth-child(1),.w3m-icons svg:nth-child(2){margin-bottom:4px}w3m-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--w3m-color-bg-3)}#wallet-placeholder-dash{stroke:var(--w3m-color-overlay)}`;
var ko = Object.defineProperty,
  $o = Object.getOwnPropertyDescriptor,
  Oo = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? $o(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && ko(t, a, r), r;
  };
let pt = class extends m {
  ...
  render() {
    const { recomendedWallets: e } = I.state,
      t = N.manualWallets(),
      a = [...e, ...t].reverse().slice(0, 4);
    return l`<button @click="${this.onClick}"><div class="w3m-icons">${a.map(
      (o) => {
        const r = s.getWalletIcon(o);
        if (r) return l`<img src="${r}">`;
        const i = s.getWalletIcon({ id: o.id });
        return i ? l`<img src="${i}">` : p.WALLET_PLACEHOLDER;
      }
...
(pt.styles = [w.globalCss, Co]),
  (pt = Oo([h("w3m-view-all-wallets-button")], pt));
const Io = g`.w3m-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
...
let ge = class extends m {
  ...
  render() {
    return l`<div class="w3m-qr-container">${
      this.uri
        ? l`<w3m-qrcode size="${this.overlayEl.offsetWidth}" uri="${this.uri}" walletId="${this.walletId}" imageId="${this.imageId}"></w3m-qrcode>`
        : l`<w3m-spinner></w3m-spinner>`
    }</div>`;
  }
};
(ge.styles = [w.globalCss, Io]),
  Se([c()], ge.prototype, "walletId", 2),
  Se([c()], ge.prototype, "imageId", 2),
  Se([f()], ge.prototype, "uri", 2),
  (ge = Se([h("w3m-walletconnect-qr")], ge));
const jo = g`.w3m-profile{display:flex;justify-content:space-between;align-items:flex-start;padding-top:20px}.w3m-connection-badge{background-color:var(--w3m-color-bg-2);box-shadow:inset 0 0 0 1px var(--w3m-color-overlay);padding:6px 10px 6px 26px;position:relative;border-radius:28px}.w3m-connection-badge::before{content:'';position:absolute;width:10px;height:10px;left:10px;background-color:var(--w3m-success-color);border-radius:50%;top:50%;margin-top:-5px;box-shadow:0 1px 4px 1px var(--w3m-success-color),inset 0 0 0 1px var(--w3m-color-overlay)}.w3m-footer{display:flex;justify-content:space-between}w3m-address-text{margin-top:10px;display:block}.w3m-balance{border-top:1px solid var(--w3m-color-bg-2);padding:11px 20px}`;
var Po = Object.defineProperty,
  Wo = Object.getOwnPropertyDescriptor,
  Dt = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? Wo(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && Po(t, a, r), r;
  };
...
(Ue.styles = [w.globalCss, jo]),
  Dt([f()], Ue.prototype, "loading", 2),
  (Ue = Dt([h("w3m-account-view")], Ue));
var Mo = Object.defineProperty,
  Lo = Object.getOwnPropertyDescriptor,
  To = (e, t, a, o) => {
    for (
...
(wt.styles = [w.globalCss]), (wt = To([h("w3m-connect-wallet-view")], wt));
const _o = g`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
var No = Object.defineProperty,
  Do = Object.getOwnPropertyDescriptor,
  Rt = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? Do(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
...
let Ve = class extends m {
  constructor() {
    super(),
      ...
      this.openDesktopApp(),
      (this.unwatchConnection = A.subscribe((e) => {
  ...
  onFormatAndRedirect(e) {
    const { desktop: t, name: a } = u.getWalletRouterData(),
      o = t == null ? void 0 : t.native;
    if (o) {
      const r = u.formatNativeUrl(o, e, a);
      u.openHref(r, "_self");
    }
  }
  openDesktopApp() {
    A.setPairingError(!1);
    const { pairingUri: e } = A.state,
      t = u.getWalletRouterData();
    s.setRecentWallet(t), this.onFormatAndRedirect(e);
  }
  render() {
    const { name: e, id: t, image_id: a } = u.getWalletRouterData(),
      {
        isMobile: o,
        isInjected: r,
        isWeb: i,
      } = s.getCachedRouterWalletPlatforms();
    return l`<w3m-modal-header title="${e}" .onAction="${
      s.handleUriCopy
    }" .actionIcon="${
      p.COPY_ICON
    }"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${t}" imageId="${a}" label="${`Continue in ${e}...`}" .isError="${
      this.isError
    }"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`Connection can continue loading if ${e} is not installed on your device`}</w3m-text><w3m-platform-selection .isMobile="${o}" .isInjected="${r}" .isWeb="${i}" .isRetry="${!0}"><w3m-button .onClick="${this.openDesktopApp.bind(
      this
    )}" .iconRight="${
      p.RETRY_ICON
...
(Ve.styles = [w.globalCss, _o]),
  Rt([f()], Ve.prototype, "isError", 2),
  (Ve = Rt([h("w3m-desktop-connecting-view")], Ve));
const Ro = g`.w3m-info-text{margin:5px 0 15px;max-width:320px;text-align:center}.w3m-wallet-item{margin:0 -20px 0 0;padding-right:20px;display:flex;align-items:center;border-bottom:1px solid var(--w3m-color-bg-2)}.w3m-wallet-item:last-child{margin-bottom:-20px;border-bottom:0}.w3m-wallet-content{margin-left:20px;height:60px;display:flex;flex:1;align-items:center;justify-content:space-between}.w3m-footer-actions{display:flex;flex-direction:column;align-items:center;padding:20px 0;border-top:1px solid var(--w3m-color-bg-2)}w3m-wallet-image{display:block;width:40px;height:40px;border-radius:10px}`;
...
let gt = class extends m {
  ...
  render() {
    const e = I.state.recomendedWallets.slice(0, 5),
      t = N.manualWallets().slice(0, 5),
      a = e.length,
      o = t.length;
    return l`<w3m-modal-header title="Get a wallet"></w3m-modal-header><w3m-modal-content>${
      a
        ? e.map(
            (r) =>
              l`<div class="w3m-wallet-item"><w3m-wallet-image walletId="${
                r.id
              }" imageId="${
                r.image_id
...
(gt.styles = [w.globalCss, Ro]), (gt = Bo([h("w3m-get-wallet-view")], gt));
const So = g`.w3m-footer-actions{display:flex;justify-content:center}.w3m-footer-actions w3m-button{margin:0 5px}.w3m-info-container{display:flex;flex-direction:column;justify-content:center;align-items:center;margin-bottom:20px}.w3m-info-container:last-child{margin-bottom:0}.w3m-info-text{margin-top:5px;text-align:center}.w3m-images svg{margin:0 2px 5px;width:55px;height:55px}.help-img-highlight{stroke:var(--w3m-color-overlay)}`;
var Uo = Object.defineProperty,
  Vo = Object.getOwnPropertyDescriptor,
  zo = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? Vo(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && Uo(t, a, r), r;
  };
...
(ut.styles = [w.globalCss, So]), (ut = zo([h("w3m-help-view")], ut));
const Go = g`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
var Fo = Object.defineProperty,
  qo = Object.getOwnPropertyDescriptor,
  Zt = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? qo(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && Fo(t, a, r), r;
  };
let ze = class extends m {
  ...
  render() {
    ...
    return l`<w3m-modal-header title="${e}"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${t}" imageId="${a}" label="${`Continue in ${e}...`}" .isError="${
      this.isError
    }"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">Connection can be declined if multiple wallets are installed or previous request is still active</w3m-text><w3m-platform-selection .isMobile="${o}" .isDesktop="${r}" .isWeb="${i}" .isRetry="${!0}"><w3m-button .onClick="${this.openInjectedApp.bind(
      this
...
(ze.styles = [w.globalCss, Go]),
  Zt([f()], ze.prototype, "isError", 2),
  (ze = Zt([h("w3m-injected-connecting-view")], ze));
const Ko = g`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}w3m-button{margin-top:15px}`;
var Yo = Object.defineProperty,
  ...
  Xo = (e, t, a, o) => {
    for (
      ...
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && Yo(t, a, r), r;
  };
let vt = class extends m {
  onInstall(e) {
    e && u.openHref(e, "_blank");
  }
  render() {
    const {
      name: e,
...
let Ge = class extends m {
  ...
  onFormatAndRedirect(e, t = !1) {
    const { mobile: a, name: o } = u.getWalletRouterData(),
      r = a == null ? void 0 : a.native,
      i = a == null ? void 0 : a.universal;
    if (r && !t) {
      const n = u.formatNativeUrl(r, e, o);
      u.openHref(n, "_self");
    } else if (i) {
      const n = u.formatUniversalUrl(i, e, o);
      u.openHref(n, "_self");
    }
  }
  openMobileApp(e = !1) {
    ...
    s.setRecentWallet(a), this.onFormatAndRedirect(t, e);
  }
  onGoToAppStore(e) {
    e && u.openHref(e, "_blank");
  }
  render() {
    const {
      ...
      n = o == null ? void 0 : o.ios,
      d = r == null ? void 0 : r.universal;
    return l`<w3m-modal-header title="${e}"></w3m-modal-header><w3m-modal-content><w3m-connector-waiting walletId="${t}" imageId="${a}" label="Tap 'Open' to continue…" .isError="${
      this.isError
    }"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer class="w3m-note"><w3m-platform-selection .isWeb="${i}" .isRetry="${!0}"><w3m-button .onClick="${() =>
      ...
      d
        ...
        : null
    }</w3m-info-footer><w3m-info-footer class="w3m-app-store"><div><w3m-wallet-image walletId="${t}" imageId="${a}"></w3m-wallet-image><w3m-text>${`Get ${e}`}</w3m-text></div><w3m-button .iconRight="${
      p.ARROW_RIGHT_ICON
    }" .onClick="${() =>
      this.onGoToAppStore(
        n
...
(Ge.styles = [w.globalCss, Jo]),
  Ht([f()], Ge.prototype, "isError", 2),
  (Ge = Ht([h("w3m-mobile-connecting-view")], Ge));
const ri = g`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
var ai = Object.defineProperty,
  oi = Object.getOwnPropertyDescriptor,
  ii = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? oi(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && ai(t, a, r), r;
  };
...
(bt.styles = [w.globalCss, ri]),
  (bt = ii([h("w3m-mobile-qr-connecting-view")], bt));
var ni = Object.defineProperty,
  li = Object.getOwnPropertyDescriptor,
  si = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? li(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && ni(t, a, r), r;
  };
let ft = class extends m {
  render() {
    return l`<w3m-modal-header title="Scan the code" .onAction="${s.handleUriCopy}" .actionIcon="${p.COPY_ICON}"></w3m-modal-header><w3m-modal-content><w3m-walletconnect-qr></w3m-walletconnect-qr></w3m-modal-content>`;
  }
};
(ft.styles = [w.globalCss]), (ft = si([h("w3m-qrcode-view")], ft));
const ci = g`div{display:grid;grid-template-columns:repeat(4,80px);margin:-5px -10px;justify-content:space-between}w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-info-footer w3m-text{text-align:center}`;
var zt = Object.defineProperty,
  ...
  St = (e, t, a) =>
    t in e
      ? zt(e, t, { enumerable: !0, configurable: !0, writable: !0, value: a })
      : (e[t] = a),
  gi = (e, t) => {
    for (var a in t || (t = {})) pi.call(t, a) && St(e, a, t[a]);
    if (Bt) for (var a of Bt(t)) wi.call(t, a) && St(e, a, t[a]);
    return e;
  },
  ui = (e, t) => di(e, hi(t)),
  xt = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? mi(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && zt(t, a, r), r;
  };
let Pe = class extends m {
  constructor() {
    super(),
  ...
  async onSelectChain(e) {
    try {
      const { selectedChain: t, isPreferInjected: a } = O.state,
        { isConnected: o } = k.state;
      o
        ? (t == null ? void 0 : t.id) === e.id
          ? x.reset("Account")
          : s.getWagmiWalletType() === '"walletConnect"'
          ? (await W.client().switchNetwork({ chainId: e.id }),
            x.reset("Account"))
          : x.push("SwitchNetwork", { SwitchNetwork: e })
        : a
        ? (O.setSelectedChain(e), R.close())
        : (O.setSelectedChain(e), x.push("ConnectWallet"));
    } catch (t) {
      console.error(t), j.openToast("Unsupported chain", "error");
    }
  }
    ...
    const { chains: e } = O.state,
      t =
        e == null
          ? void 0
          : e.map((o) =>
              ui(gi({}, o), { unsupported: this.isUnsuportedChainId(o.id) })
            ),
      a =
        t == null
          ? void 0
          : t.sort((o, r) => Number(o.unsupported) - Number(r.unsupported));
    return l`<w3m-modal-header title="Select network"></w3m-modal-header><w3m-modal-content><div>${
      a == null
        ? void 0
        : a.map(
            (o) =>
              l`<w3m-network-button name="${o.name}" chainId="${
                o.id
              }" .unsupported="${o.unsupported}" .onClick="${async () =>
                this.onSelectChain(o)}">${o.name}</w3m-network-button>`
          )
    }</div></w3m-modal-content>${
...
(Pe.styles = [w.globalCss, ci]),
  xt([f()], Pe.prototype, "connectedChains", 2),
  xt([f()], Pe.prototype, "isUnsupportedChains", 2),
  (Pe = xt([h("w3m-select-network-view")], Pe));
const vi = g`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}w3m-button{margin-top:15px}`;
var bi = Object.defineProperty,
  fi = Object.getOwnPropertyDescriptor,
  Ut = (e, t, a, o) => {
    for (
      var r = o > 1 ? void 0 : o ? fi(t, a) : t, i = e.length - 1, n;
      i >= 0;
      i--
    )
      (n = e[i]) && (r = (o ? n(t, a, r) : n(r)) || r);
    return o && r && bi(t, a, r), r;
  };
let Fe = class extends m {
  ...
  async onSwitchNetwork() {
    try {
      this.isError = !1;
      const e = u.getSwitchNetworkRouterData();
      await W.client().switchNetwork({ chainId: e.id }),
        O.setSelectedChain(e),
        x.reset("Account");
    } catch {
      this.isError = !0;
    }
  ...
  render() {
    const { id: e, name: t } = u.getSwitchNetworkRouterData();
    return l`<w3m-modal-header title="${`Connect to ${t}`}"></w3m-modal-header><w3m-modal-content><w3m-network-waiting chainId="${e}" label="Approve in your wallet" .isError="${
      this.isError
...
let ae = class extends m {
  constructor() {
    super(...arguments),
      ...
      (this.searchDebounce = s.debounce((e) => {
        e.length >= 3
          ? ((this.firstFetch = !0),
            (this.endReached = !1),
            (this.search = e),
  ...
  isLastPage() {
    const { wallets: e, search: t } = I.state,
      { listings: a, total: o } = this.search ? t : e;
    return o <= yt || a.length >= o;
  }
  async fetchWallets() {
    const { wallets: e, search: t, injectedWallets: a } = I.state,
      { listings: o, total: r, page: i } = this.search ? t : e;
    if (!this.endReached && (this.firstFetch || (r > yt && o.length < r)))
      try {
        this.loading = !0;
  ...
  onConnect(e) {
    u.isAndroid() ? s.handleMobileLinking(e) : s.goToConnectingView(e);
  }
  onSearchChange(e) {
  ...
  render() {
    const { wallets: e, search: t } = I.state,
      { listings: a } = this.search ? t : e,
      o = this.loading && !a.length,
    ...
    r &&
      ...
      (i = i.filter(
        (Z) => !d.find((D) => s.caseSafeIncludes(Z.values[0], D.values[0]))
      ));
    ...
    return l`<w3m-modal-header><w3m-search-input .onChange="${this.onSearchChange.bind(
      this
    )}"></w3m-search-input></w3m-modal-header><w3m-modal-content class="${P(
      H
    )}"><div class="w3m-grid">${o ? null : d} ${
      o
        ? null
        : [...Array(y)].map(
            (Z, D) =>
              l`${n[D]} ${i[D]} ${
                a[D]
                  ? l`<w3m-wallet-button imageId="${a[D].image_id}" name="${
                      a[D].name
                    }" walletId="${a[D].id}" .onClick="${() =>
                      this.onConnect(a[D])}"></w3m-wallet-button>`
                  : null
              }`
          )
...
(ae.styles = [w.globalCss, xi]),
  We([f()], ae.prototype, "loading", 2),
  We([f()], ae.prototype, "firstFetch", 2),
  We([f()], ae.prototype, "search", 2),
  We([f()], ae.prototype, "endReached", 2),
  (ae = We([h("w3m-wallet-explorer-view")], ae));
const ki = g`w3m-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}w3m-text{text-align:center}`;
...
let qe = class extends m {
  ...
  onFormatAndRedirect(e) {
    ...
    if (o) {
      const r = u.formatUniversalUrl(o, e, a);
      u.openHref(r, "_blank");
    }
  }
  openWebWallet() {
  ...
  render() {
    ...
    return l`<w3m-modal-header title="${e}" .onAction="${
      ...
      this.isError
    }"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer><w3m-text color="secondary" variant="small-thin">${`${e} web app has opened in a new tab. Go there, accept the connection, and come back`}</w3m-text><w3m-platform-selection .isMobile="${o}" .isInjected="${
      n ? !1 : r
    }" .isDesktop="${
      n ? !1 : i
...
(qe.styles = [w.globalCss, ki]),
  Vt([f()], qe.prototype, "isError", 2),
  (qe = Vt([h("w3m-web-connecting-view")], qe));
export {
  $e as W3mAccountButton,
